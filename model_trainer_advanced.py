...
def train_models_advanced():
    ...
    print("\n[INFO] Обучение моделей с разморозкой слоев...")
    ...
    for model_type, epochs_before, epochs_after in model_configs:
        ...
        model_path = os.path.join(MODEL_SAVE_PATH, f"{model_type}.keras")
    ...
    ensemble_models = [trained_models[name] for name in ['simple_cnn', 'mobilenetv2', 'vgg16']]
